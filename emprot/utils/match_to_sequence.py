...
from emprot.utils.misc_utils import assertion_check
from emprot.utils.residue_constants import restype_3_to_index
...
class MatchToSequence:
    def __init__(
        ...
        residue_idxs=None,
        sequence_idxs=None,
        key_start_matches=None,
        key_end_matches=None,
        match_scores=None,
        hmm_output_match_sequences=None,
        exists_in_sequence_mask=None,
        is_nucleotide=None,
    ):
        self.set_vals(
            new_sequences,
