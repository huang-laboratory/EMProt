...
import emprot.utils.residue_constants as _rc
...
def frames_and_literature_positions_to_atom3_pos(
    ...
    """
    # If ndarray
    if isinstance(all_frames_to_global, np.ndarray):
        all_frames_to_global = torch.from_numpy(all_frames_to_global).float()
